...
# ---------------------------------------------------------------------------
# S3 bucket - private, versioned, encrypted. Content is only ever served via
# CloudFront (through Origin Access Control below), never directly from S3.
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# CloudFront - Origin Access Control (modern replacement for OAI) locks the
# S3 bucket down to requests coming from this specific distribution only.
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Optional custom domain: ACM certificate (must be in us-east-1 for
# CloudFront) validated via Route 53 DNS, plus the A/AAAA alias records.
# Skipped entirely when var.domain_name is empty.
# ---------------------------------------------------------------------------
